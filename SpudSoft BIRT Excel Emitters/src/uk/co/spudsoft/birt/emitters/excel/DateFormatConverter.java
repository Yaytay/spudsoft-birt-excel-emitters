...
public class DateFormatConverter  {
	...
	private static Map<String,String> prepareLocalePrefixes() {
		...
		result.put( "as", "[$-10144D]" );
		result.put( "az_az", "[$-10182C]" );
		result.put( "az_az", "[$-10142C]" );
		...
		result.put( "eu", "[$-10142D]" );
		result.put( "fa", "[$-1010429]" );
		result.put( "fi", "[$-10140B]" );
		result.put( "fo", "[$-1010438]" );
		result.put( "fr_be", "[$-10180C]" );
		result.put( "fr_ca", "[$-101C0C]" );
		result.put( "fr_ch", "[$-101100C]" );
		result.put( "fr_fr", "[$-10140C]" );
		result.put( "fr_lu", "[$-101140C]" );
		result.put( "gd", "[$-10143C]" );
		result.put( "gd_ie", "[$-10183C]" );
		result.put( "gn", "[$-1010474]" );
		result.put( "gu", "[$-1010447]" );
		result.put( "he", "[$-10140D]" );
		result.put( "hi", "[$-1010439]" );
		result.put( "hr", "[$-10141A]" );
		result.put( "hu", "[$-10140E]" );
		result.put( "hy", "[$-10142B]" );
		result.put( "id", "[$-1010421]" );
		result.put( "is", "[$-10140F]" );
		result.put( "it_ch", "[$-1010810]" );
		result.put( "it_it", "[$-1010410]" );
		result.put( "ja", "[$-1010411]" );
		result.put( "kk", "[$-10143F]" );
		result.put( "km", "[$-1010453]" );
		result.put( "kn", "[$-10144B]" );
		...
		result.put( "mk", "[$-10142F]" );
		result.put( "ml", "[$-10144C]" );
		result.put( "mn", "[$-1010850]" );
		result.put( "mn", "[$-1010450]" );
		result.put( "mr", "[$-10144E]" );
		result.put( "ms_bn", "[$-10183E]" );
		result.put( "ms_my", "[$-10143E]" );
		result.put( "mt", "[$-10143A]" );
		...
		result.put( "sa", "[$-10144F]" );
		result.put( "sb", "[$-10142E]" );
		result.put( "sd", "[$-1010459]" );
		result.put( "si", "[$-10145B]" );
		result.put( "sk", "[$-10141B]" );
		result.put( "sl", "[$-1010424]" );
		result.put( "so", "[$-1010477]" );
		result.put( "sq", "[$-10141C]" );
		result.put( "sr_sp", "[$-101C1A]" );
		result.put( "sr_sp", "[$-10181A]" );
		result.put( "sv_fi", "[$-10181D]" );
		result.put( "sv_se", "[$-10141D]" );
		result.put( "sw", "[$-1010441]" );
		result.put( "ta", "[$-1010449]" );
		result.put( "te", "[$-10144A]" );
		result.put( "tg", "[$-1010428]" );
		result.put( "th", "[$-10141E]" );
		result.put( "tk", "[$-1010442]" );
		result.put( "tn", "[$-1010432]" );
		result.put( "tr", "[$-10141F]" );
		...
		result.put( "vi", "[$-10142A]" );
		result.put( "xh", "[$-1010434]" );
		result.put( "yi", "[$-10143D]" );
		result.put( "zh_cn", "[$-1010804]" );
		result.put( "zh_hk", "[$-101C04]" );
